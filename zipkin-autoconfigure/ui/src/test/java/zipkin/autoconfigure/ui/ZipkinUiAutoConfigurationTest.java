...
public class ZipkinUiAutoConfigurationTest {
  ...
  public void canOverrideProperty_dependencyLowErrorRate() {
    ...
    assertThat(context.getBean(ZipkinUiProperties.class).getDependencyLowErrorRate())
      .isEqualTo(0.1f);
  }
  ...
  public void canOverrideProperty_dependencyHighErrorRate() {
    ...
    assertThat(context.getBean(ZipkinUiProperties.class).getDependencyHighErrorRate())
      .isEqualTo(0.1f);
  }
